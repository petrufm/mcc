...
LocalBodyId::LocalBodyId(DataExtractor *next, ConcreteTableColumn *prototype, LocalVariable *condition, BodyTable *bodies):DataExtractor(next,prototype,condition) {

	this->bodies = bodies;

}

TableColumn* LocalBodyId::handleExtraction(AbstractTree &tree) {
